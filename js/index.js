...
const displayListVideos = (videos) => {
    ...
    li.innerHTML = `
      <article class="video-card">
        <a class="video-card__link" href="./video.html?id=${video.id}">
          ...
          <p class="video-card__duration">${showReadableDuration(video.contentDetails.duration)}</p>
        </a>
